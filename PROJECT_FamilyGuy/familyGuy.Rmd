...
```{r textPrep, message=FALSE, echo=TRUE}
# Bag of Words
family_tidy <- family %>% 
...
```{r season, echo=TRUE, fig.align='center', fig.height=8, fig.width=10}
